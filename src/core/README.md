...
- [`action-event.ts`](./action-event.ts): Custom bubbling event dispatched on keydown when hovered containing key and mouse coordinates (`ActionEvent`, `MousePosition`).
